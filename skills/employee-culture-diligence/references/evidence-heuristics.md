...
They can be distorted by irrelevant functions, acquired businesses, layoffs, old reviews, geography, support/customer-service populations, and different expectations around compensation or WLB.
...
Higher-confidence evidence often includes exact role, recent date, current/former status, tenure, detailed text, a relevant subgroup page, and independent corroboration.
